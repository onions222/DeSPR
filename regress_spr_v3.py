...
if __name__ == '__main__':
    ...
    def objective(trial):
        ...
        enhance_coeffs = [
            trial.suggest_float("enhance0", 0.01, 0.8),
            trial.suggest_float("enhance1", 0.01, 0.8),
            trial.suggest_float("enhance2", 0.01, 0.8)
        ]
        reduce_coeffs = [
            trial.suggest_float("reduce0", 0.01, 0.8),
            trial.suggest_float("reduce1", 0.01, 0.8),
            trial.suggest_float("reduce2", 0.01, 0.8)
        ]
